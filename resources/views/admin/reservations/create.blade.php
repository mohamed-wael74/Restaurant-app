            ...
            <form method="POST" action="{{ route('admin.reservation.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="first_name" name="first_name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue @error('first_name') border-red-500 @enderror">
                    @error('first_name')
                ...
                <div class="mb-3">
                    ...
                    <div class=" mt-1">
                        <select name="table_id"
                            class=" form-multiselect block w-full mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('table_id') border-red-500 @enderror">
